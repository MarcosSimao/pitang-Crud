              ...
              $('.formulario').validate({
                 ...
                 messages:{
                      email:{
                        ...
                        email:"coloque um email existente"
                         
                     },
                     senha:{
                         required:"esse campo é obrigatorio",
                         rangelength:"menos de 4 é um risco preenchaate 10 caractere"
                     }
                 }
      });  
            });
        ...
        <div class="form-area">
            ...
            <form class="formulario"  action="../loginservlet" method="POST">
                ...
                <input type="text" name="email" placeholder="Email"/>
                 <P>Senha:</p>
                <input type="password" maxlength="10" name="senha" placeholder="Password"/>
                 <button class="entrar" type='submit'>entrar</button>
                </form>
            
            <p>mudar senha</p>
            <a href="cadastro.jsp" ><button class="cadastro">criar conta</button></a>
