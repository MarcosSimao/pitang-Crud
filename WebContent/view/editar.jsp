...
<script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
    ...
    <body>
        ...
        <div class="form-area ">
            ...
            <c:forEach var="use" items="${userId}">
            
                <input type="hidden" class="mod" name="id" id="id"   value="${use.getId()}">/>
                <P>nome*</p>
                <input type="text" name="nome" placeholder="nome"   value="${use.getNome()}"/>
                <P>Email*</p>
                <input type="text" name="email" placeholder="Email"  value="${use.getEmail()}"/>
                 <P>Senha*</p>
                <input type="password" id="senha" name="senha" placeholder="Password" value="${use.getSenha()}"/>
                <P>repita a senha*</p>
                
                <input type="password" name="senha2" placeholder="Password" value="${use.getSenha()}"/>
                <P>DDD*</p>
                <input type="number" name="ddd"placeholder="(00)" value="${use.getPhones().get(0).getDdd()}"/>
                <P>telefone*</p>
                <input  type="tel"  name="fixo" placeholder="0000-0000" value="${use.getPhones().get(0).getNumero()}"/>
                <P>celular*</p>
                 <input  type="tel"   name="celular"  placeholder="00000-0000" value="${use.getPhones().get(1).getNumero()}"/>
                 </c:forEach>
                 <button type='submit' class="entrar">editar</button>
                </form>
            <div class="resp">ola mundo</div>
            <a href="listarServlet"><button class="cadastro">voltar</button></a>
