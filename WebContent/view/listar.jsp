...
color:#000;
    ...
    <body>
        ...
        <div class="listas">
            ...
            <table class="tabela">
                <caption><svg class="agile" enable-background="new 0 0 295.3 134" version="1.1" viewBox="0 0 295.3 134" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
            ...
            <thead>
           <tr>
                <th>id</th><th>Nome</th><th>E-mail</th><th>Senha</th><th class="ddd">DDD</th><th>Residencial</th><th>Celular</th>
                
                </tr>
                </thead>
                
                <tbody>
           <c:forEach var="use" items="${listaUser}">
	      <tr>
	        <th><c:out value="${use.getId()}"></c:out></th>
	        <td><c:out value="${use.getNome()}"></c:out></td>
	        <td><c:out value="${use.getEmail()}"></c:out></td>
	        <td><c:out value="${use.getSenha()}"></c:out></td>
	        <td><c:out value="${use.getPhones().get(0).getDdd()}"></c:out></td>
	        <td><c:out value="${use.getPhones().get(0).getNumero()}"></c:out></td>
	        <td><c:out value="${use.getPhones().get(1).getNumero()}"></c:out></td>
	        <td>
	        <td class="ed"><a href="editarServlet?id=<c:out value="${use.getId()}"></c:out>">editar</a></td><td><a href="excluirServlet?id=<c:out value="${use.getId()}"></c:out>" class="btn btn-danger">excluir</a></td>
